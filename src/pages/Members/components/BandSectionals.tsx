...
const BandSectional = (props: SectionalProps) => (
    ...
    <div className="col-12 col-md-6 col-xl-5 pl-4">
      ...
      <div className="row">
        {props.names.map((name, i) => (
          <div key={i} className="col-6 border-left member-names">
            {name}
          </div>
        ))}
      </div>
...
const BandSectionals = (props: SectionalsProps) => (
  <div>
    {props.sectionals.map((section, i) => (
      <BandSectional {...section} key={i} imgFirst={i % 2 !== 0} />
    ))}
  </div>
);
